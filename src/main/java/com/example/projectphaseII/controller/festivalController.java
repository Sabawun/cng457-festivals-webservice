...
public class festivalController {
    ...
    public List<Festival> getCoursesByCodeAndNameTogether(@RequestParam("festivalName") String name){
        return festivalService.getFestivalsByfestivalName(name);
    }

    @GetMapping("/popularfestivals")
    public List<Festival> getPopularFestivals(){
        return festivalService.getHighestfestivalRuns();
    }
